...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lecture.field'
        db.add_column('events_lecture', 'field',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=47, blank=True),
                      keep_default=False)

        # Adding field 'Lecture.materials'
        db.add_column('events_lecture', 'materials',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lecture.field'
        db.delete_column('events_lecture', 'field')

        # Deleting field 'Lecture.materials'
        db.delete_column('events_lecture', 'materials')
